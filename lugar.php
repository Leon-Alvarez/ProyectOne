...
if($Nombre==""||$Descripcion==""||$Telefono==""||$Facebook==""||$Horario==""){
    $Alert="Alguno de los datos estan vacios";
}
else{
    $registro="INSERT INTO Usuario(Nombre,Descripcion,Telefono,Facebook,Horario) VALUES ('$Nombre','$Descripcion','$Telefono','$Facebook','$Horario')";
...
<meta charset="UTF-8">
    ...
    <title> Registro del Lugar </title>
</head>
<body>
