...
<body>
	...
	<div class="container col-6 border shadow p-2">
					<h4 class="card-title text-center"> Inicio Sesion </h4>
					<hr>
					<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method ="post">
						<div class="form-grup">
							<div class="input-group">
								<label for="N_user" class="form-label mt-4 ms-5">Escribe tu  Usuario</label>
								 <input type="text" class="form-control w-75 mx-auto" name="usuario" placeholder="Ingresa tu Usuario" required>
							</div>
